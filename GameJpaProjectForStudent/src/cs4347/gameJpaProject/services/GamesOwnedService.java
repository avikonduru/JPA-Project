...
{
    void create(GamesOwned gamesOwned) throws DAOException, SQLException;
    ...
    void update(GamesOwned gamesOwned) throws DAOException, SQLException;

    void delete(Long gamesOwnedID) throws DAOException, SQLException;
